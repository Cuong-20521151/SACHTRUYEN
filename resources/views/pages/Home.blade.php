...
<div class="container my-4">
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">
        @foreach ($truyen_moi->take(6) as $key => $value)
        <div class="col">
    ...
    <div class="mt-4 text-center">
        <a class="btn btn-success" href="{{url('truyen-moi/')}}">Xem tất cả</a>
    </div>
</div>
...
<div class="container my-4">
    ...
    <div class="mt-4 text-center">
        <a class="btn btn-success" href="{{url('truyen-hay/')}}">Xem tất cả</a>
    </div>
</div>
@endsection
